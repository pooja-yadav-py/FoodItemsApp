  ...
  if(!props.foodItems || props.foodItems && props.foodItems.length==0){
   return(
    ...
    return(
        ...
        <div className="container d-flex justify-content-center">
          <div className="card my-3 me-3" style={{width: '11rem'}} onClick={() => showPizzaItems(0)}>
           <div className="outerDiv"> 
            <div className="innerdiv">
              <img src={props.foodItems[0].image} className="card-img-top" alt="pizza" />
            </div>
         ...
         <div className="outerDiv1"> 
          <div className="innerdiv1">
              <img src={props.foodItems[1].image} className="card-img-top" alt="image" />
          </div>
          <div className="card-body">
       ...
       {!props.cartOpen && <BurgerList selectedList={props.selectedList} cartItems={props.cartItems} setCartItems={props.setCartItems} foodItems={props.foodItems}/>}
