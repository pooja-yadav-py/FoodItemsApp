...
const App = () => {
  ...
  async function fetchFoodItems() {
    ...
    //console.log("mydata" + dataFormAPI);
  ...
  <Home cartItems={cartItems} setCartItems={setCartItems} cartOpen={cartOpen} updateCartOpen={updateCartOpen} selectedList={selectedList} updatedSelectedList={updatedSelectedList} foodItems={foodItems}/>
